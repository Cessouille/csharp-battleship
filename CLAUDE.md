...
documenté, ainsi que dix extensions au-delà du socle : options de partie, radar, Salvo, armes spéciales,
placement manuel de la flotte (ADR 0013), IA à difficulté réglable (ADR 0015), Salve en second flux gRPC-Web
(ADR 0014), journal de partie (ADR 0016), système de succès + profil joueur anonyme (ADR 0017/0018), et mini-jeu
de précision par timing pour l'attaque et la défense (ADR 0019). Aucun scaffold `dotnet new` résiduel (pages
Weather/Counter, `Class1.cs`, `UnitTest1.cs` déjà supprimés).
